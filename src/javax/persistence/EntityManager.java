...
public interface EntityManager {
	...
	/**
	 * Get a reference to an instance, whose state may be
	 * lazily fetched.
	 * If the requested instance does not exist in the database,
	 * throws EntityNotFoundException when get is called or
	 * when the instance state is first accessed.
    ...
    * @throws EntityNotFoundException if the entity no longer exists in the database
    ...
    /**
     * Set the flush mode type to be used for the entity manager
     * 
     * @param flushMode
     */
